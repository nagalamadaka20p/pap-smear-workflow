  ...
  return (
    <div className="home">
      ...
      <div className="question">
        <h2>What is HPV?</h2>
        <button onClick={toggleHPVAnswer}>
          {showHPVAnswer ? "-" : "+"}
        </button>
        {showHPVAnswer && (
          <p className={`answer-paragraph ${showHPVAnswer ? "show" : ""}`}>
            ...
            increase risk of anal, penile and oral cancers.{" "}
          </p>
        )}
      </div>
        ...
        {showGardasilAnswer && (
          <div className={`answer ${showGardasilAnswer ? "show" : ""}`}>
            <p>
              ...
              vulvar cancers in females, anal cancer, certain head and neck
              cancers, such as throat and back of mouth cancers and genital warts
            ...
            <ul>
              <li>
                ...
                the second shot is given less than 5 months after the first shot,
                a third shot should be given at least 4 months after the second
                shot. For the 3-dose schedule, the second shot should be given 2
              ...
              <li>
                ...
                the first shot and the third shot should be given 6 months after
                the first shot.
              </li>
            </ul>
            <p>
              The appropriate dosing schedule will be determined by a health care
              professional.
            </p>
            <p>
      ...
      <div className="question">
        ...
        {showCervicalPreCancerAnswer && (
          <p className={`answer-paragraph ${showCervicalPreCancerAnswer ? "show" : ""}`}>
            ...
            Cervical precancer usually doesn't cause pain or other symptoms. It is
            found with a Pap test. Click <a href="https://www.cdc.gov/cancer/cervical/basic_info/screening.htm#:~:text=Cervical%20precancer%20usually%20doesn't,Cervical%20Cancer%20Early%20Detection%20Program">here</a> for more info.
          </p>
        )}
      </div>
        ...
        {showPortalAnswer && (
          <div className={`answer ${showPortalAnswer ? "show" : ""}`}>
            ...
            <p>
              ...
              care. Patient portals can also save your time, help you communicate
